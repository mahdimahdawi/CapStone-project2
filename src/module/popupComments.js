import { add, get } from './addShowComments.js';

const popCont = document.querySelector('.pupop-comments');
...
const displayPopup = async (data, id) => {
  ...
  <button id=${id} type="button" class = "reservation-btn">Comment</button>
  </div>
  </div>
  `;
